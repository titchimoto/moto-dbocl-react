      ...
      <Flex width="100%" justifyContent='space-around'>
        ...
        <Box width={1/1} px ={3}>
            <Flex flexDirection="column">
              <Box width={1/1}>
                <TextInput label="Name" disabled required />
              </Box>
              <Box width={1/1}>
              ...
              <Box width={1/1}>
                <TextInput placeholder="Additional information to appear on itinerary..." label="Additional Information" />
              </Box>
            </Flex>
          </Box>
        </div>
...
export default ExistingEventItinerary
